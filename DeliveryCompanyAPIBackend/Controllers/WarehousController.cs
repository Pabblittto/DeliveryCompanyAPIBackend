...
namespace DeliveryCompanyAPIBackend.Controllers
{
    ...
    public class WarehousController : ControllerBase
    {
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            {
                Messages.Add("Warehouse with certain id was not found");
                return NotFound(Messages);
            }
        ...
        public async Task<ActionResult> Add([FromBody]Warehous warehouse)
        {
            ...
            var department = await _context.Departments.FirstOrDefaultAsync(ob => ob.Id == warehouse.DepartmentId);
            ...
            NewWarehouse.department = department;
